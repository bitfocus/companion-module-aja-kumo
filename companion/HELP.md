...
`#` indicates the number of the source or destination.

- Source and destination names:
  - `$(kumo:src_name_#_line1)`
  - `$(kumo:src_name_#_line2)`
  - `$(kumo:dest_name_#_line1)`
  - `$(kumo:dest_name_#_line2)`
- Source and destination combination name for button labels:
  - `$(kumo:src_#_label_combo)`
  - `$(kumo:dest_#_label_combo)`
...
- Destination is Locked
  - When a specific destination is locked
